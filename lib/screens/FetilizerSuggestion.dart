...
class FetilizerSuggestion extends StatefulWidget {
  static const String id = 'Fertilizer_screen';
  const FetilizerSuggestion({Key? key}) : super(key: key);

  @override
  State<FetilizerSuggestion> createState() => _FetilizerSuggestionState();
}

class _FetilizerSuggestionState extends State<FetilizerSuggestion> {
